...
class App(customtkinter.CTk, post_machine):
    ...
    def __init__(self):
        ...
        #############################################
        #фрейм два(реаизованы функции ввода)
        #############################################
        ...
        #############################################
        # фрейм три(реаизованы функции вывода)
        #############################################
    ...
    def _start(self):
        ...
        self.wr_head = len(self.first_tape_list) // 2 #индекс пишущей головки машины, вначале задаем ей положение в середине
        ...
        iter = 0 #шаг
        maxIter = 300 #максимальное коллчество шагов
        current_tape = [] #текущее состояние ленты

        #Впервую очередь проверяем корректность ленты
        if self._corect_input_tape(self.first_tape_list):
            #пока состоянием машины True и программа не превысила максимальное колличество шагов
            while work and iter <= maxIter:
                ...
                if self._corect_step(step):
                    ...
                    #В зависимости от возвращаемых значений проигрываем один из можных сценариев
